...
if __name__ == '__main__':
    ...
    from src.TPRNN import TPRNN

    model_path = "../egs/models/DPRNN_SE_LSTM_N_64_B_96_hidden_128_chunk_180_L_6.pth"
    model_dprnn = DPRNN.load_model(model_path)

    model_path = "../egs/models/speech_enhancement_si_sdr.pth"
    model_tasnet = ConvTasNet.load_model(model_path)

    model_path = "../egs/models/TPRNN_SE_GRU_N_128_B_256_hidden_256_layers_3_L_6_sr_8k_batch_256_hours_30.pth"
    model_tprnn = TPRNN.load_model(model_path)
